...
bool XAudio2SoundDriverLegacy::ClassRegistered = XAudio2SoundDriverLegacy::ValidateDriver() ? SoundDriverFactory::RegisterSoundDriver(SND_DRIVER_XA2L, XAudio2SoundDriverLegacy::CreateSoundDriver, "XAudio2 Legacy Driver", 11) : false;
...
u32 XAudio2SoundDriverLegacy::AddBuffer(u8* start, u32 length)
{
    ...
    if (Configuration::getSyncAudio() == true || Configuration::getForceSync() == true)
        while (filledBuffers == 10)
            Sleep(1);
    else if (filledBuffers == 10)
        return 0;
...
u32 XAudio2SoundDriverLegacy::GetReadStatus()
{
    ...
    if (xvs.BuffersQueued == 0 || Configuration::getForceSync() == true)
        return 0;
